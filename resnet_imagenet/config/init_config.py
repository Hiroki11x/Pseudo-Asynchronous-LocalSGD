...
def load_config():
    ...
    parser.add_argument("--loss_name", type=str, default="cross_entropy", choices=["cross_entropy", "label_smoothing"])
    ...
    parser.add_argument("--prob_no_grad", type=float, default=0.1)
    ...
    parser.add_argument("--checkpoint_dir", type=str, default= ROOT_PATH + "/checkpoints")
